...
module RegisterFile(
    ...
    initial begin
        for (i = 0; i <= 31; i = i + 1) begin
            ...
            if (i == 29) begin 
                //setting sp to point to the last thing in data memory
                registers[i] = 32'd16380; //size of data mem = 4096, (4096 - 1) * 4
                end 
            else begin registers[i] = 32'h00000000; end
        end
    end
    ...
    always @(ReadRegister1, ReadRegister2, registers) begin
