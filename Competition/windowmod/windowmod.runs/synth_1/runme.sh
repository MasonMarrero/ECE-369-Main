...
HD_PWD='C:/Users/alexr/Documents/Projects/ECE-369/Competition/windowmod/windowmod.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sadmodule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sadmodule.tcl
