...
HD_PWD='C:/Users/Administrator/Documents/GitHub/ECE-369/testing/SADModule/SADModule.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log find_min_128.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source find_min_128.tcl -notrace
