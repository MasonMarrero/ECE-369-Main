...
HD_PWD='C:/Users/alexr/Documents/Projects/ECE-369/testing/bitonictesting/bitonictesting.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitonic_sort_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitonic_sort_8.tcl
